...
class MemberController extends AbstractController{
    ...
    #[Route('/account/admin', name: 'app_account_admin', methods:'GET')]
    public function adminPannel(): Response
    {
        return $this->render('/Back/admin.html.twig');
    }

    #[Route('/account/admin/members', name: 'app_account_manage_members', methods:['GET'])]
    ...
    #[Route('/account/admin/members/modify/{memberId}', name: 'app_account_manage_modify_member', methods:['GET', 'POST'])]
    ...
    #[Route('/account/admin/members/delete/{memberId}', name: 'app_account_manage_delete_member', methods:['GET', 'POST'])]
